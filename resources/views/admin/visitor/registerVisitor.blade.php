                                        ...
                                        <div class="form-group {{ $errors->has('employee_id') ? 'has-error' : ''}}">
                                            ...
                                            <select id="employee_id" name="employee_id" class="form-control select2 @error('employee_id') is-invalid @enderror">
                                                ...
                                                @foreach($employees as $key => $employee)
                                                        <option value="{{ $employee->id }}" value="{{ $employee->id }}" {{ isset($visitor->invitation->employee_id) && $visitor->invitation->employee_id == $employee->id ? "selected" : '' }}>{{ $employee->name }} </option>
                                                    @endforeach
                                            </select>
