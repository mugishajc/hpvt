...
Route::get('/Room/Time-Availability-Slots',[AdminUserController::class, 'view_room_Slots'])->name('room_slots');

Route::get('/Room/Time-Availability-Slots/Create',[AdminUserController::class, 'new_Slots'])->name('create_slot');


Route::get('/admin/visitors',[AdminUserController::class, 'showIndex']);

Route::post('/admin/visitors/create', [AdminUserController::class, 'checkTimeSlots'])->name('check_slots');


Route::post('/Visitor/signup', [AdminUserController::class, 'registerV'])->name('register_visitor');



Route::post('/Room/Store/Time/Slots', [AdminUserController::class, 'create_slots'])->name('store_slots');


Route::get('/Visitor/Availability',[AdminUserController::class, 'checkRoomAvailability'])->name('visitor_availability');


    
Route::post('Visitor/Availability-Store', [VisitorController::class, 'insert_visitor'])->name('store_visitor');
