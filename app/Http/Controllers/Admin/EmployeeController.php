...
class EmployeeController extends Controller
{
    ...
    public function store(EmployeeRequest $request)
    {
        ...
        .$request->input('last_name').' Your account on Hospital Patient tracker system has been created successfully. Joined the hospital at ' .$request->input('date_of_joining').' Thank you for using HPVT, powered by Zacharie Auca ';
